...
class PatternParser:
    ...
    def next_node(self) -> Node | None:
        ...
        if next is None:
            ...
            return self.parse_boundary_assertion()
        else:
            return self.parse_literal()
        
    def parse_optional(self) -> OptionalNode:
        pre_open_pos = self.mark()
        self.next()  # consume '['
        post_open_pos = self.mark()
    ...
    def parse_wildcard(self) -> WildcardNode:
        self.next()  # consume '?'
        return WildcardNode()
    
    def parse_boundary_assertion(self) -> BoundaryAssertionNode:
        self.next()  # consume '|'
    ...
    def accept(self, chars: str) -> bool:
        '''
